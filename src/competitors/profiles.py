...
PROFILES: dict[str, SiteProfile] = {
    ...
    # Меню лежит на ГЛАВНОЙ (burgerkingrus.ru/menu — несуществующая страница),
    # но одной её мало: 105 позиций против 143-178 в ручных срезах. С обходом
    # разделов /category/NN выходит 140 уникальных имён — это и есть меню.
    # Дубли между разделами стабильны от прогона к прогону и диффы не портят.
